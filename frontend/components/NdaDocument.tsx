      ...
      <div className="px-12 py-10 print:px-8 print:py-6">
        ...
        <div className="mt-8 pt-6 border-t border-gray-300">
          <p className="text-xs text-gray-500 text-center leading-relaxed">
            <strong>DRAFT — FOR REVIEW PURPOSES ONLY.</strong> This document was generated by Prelegal and has not been reviewed by an attorney. It does not constitute legal advice and should not be relied upon as such. Please consult a qualified legal professional before signing.
          </p>
        </div>
      </div>
    </div>
